...
export default function NewsManagement() {
  ...
  const openCreate = () => { setEditingItem(null); setFormData({ title: '', content: '', image_url: '', author: '' }); setShowModal(true); };
  const openEdit = (item) => { setEditingItem(item); setFormData({ title: item.title, content: item.content, image_url: item.image_url || '', author: item.author || '' }); setShowModal(true); };
