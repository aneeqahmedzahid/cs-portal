          ...
          <div className="bg-white rounded-[32px] p-8 w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl border border-slate-100" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button onClick={handleSave} disabled={saving || uploading} className="flex-1 py-3.5 bg-primary hover:bg-blue-800 text-white font-black rounded-2xl text-[11px] shadow-lg shadow-primary/20 transition-all disabled:opacity-50 flex items-center justify-center gap-2">
