    ...
    <div className="max-w-[1400px] mx-auto space-y-6 pb-20">
      <div className="bg-white rounded-[32px] shadow-sm border border-slate-200 p-8 lg:p-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
          ...
          <button onClick={() => { setFormData({ email: '', password: '' }); setShowModal(true); }} className="flex items-center justify-center gap-3 px-8 py-3.5 rounded-2xl font-black text-[11px] bg-primary text-white hover:bg-blue-800 shadow-lg shadow-primary/20 transition-all w-full lg:w-auto">
      ...
      {showModal && (
        <div className="fixed inset-0 z-[100] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setShowModal(false)}>
          <div className="bg-white rounded-[32px] p-8 w-full max-w-md shadow-2xl border border-slate-100" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button onClick={handleSave} disabled={saving || !formData.email || !formData.password} className="flex-1 py-3.5 bg-primary hover:bg-blue-800 text-white font-black rounded-2xl text-[11px] shadow-lg shadow-primary/20 transition-all disabled:opacity-50">
